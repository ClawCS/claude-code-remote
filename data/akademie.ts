...
**Wein bleibt**: Trotz aller Herausforderungen ist Wein das kulturelle Getränk schlechthin — 8.000 Jahre Geschichte werden nicht enden. Die Zukunft wird vielfältiger, nachhaltiger und technologischer sein — aber die Magie eines großen Weins bleibt: Terroir im Glas.`,
...

  {
    ...
    title: "Mineralwasser",
    icon: "💧",
    description: "Quellen, Geologie, Mineralisierung, Kohlensäure, Gesundheit und die Wissenschaft des Wassers.",
    color: "from-blue-500 to-blue-700",
    difficulty: "Einsteiger",
    duration: "ca. 30 Min.",
    lessons: [
      { title: "Was macht Mineralwasser zum Mineralwasser?", content: "**Natürliches Mineralwasser** ist gesetzlich streng definiert (Mineral- und Tafelwasserverordnung): Es muss aus einer **amtlich anerkannten unterirdischen Quelle** stammen, **direkt an der Quelle abgefüllt** werden und eine **gleichbleibende Zusammensetzung** an Mineralstoffen haben. Es darf NICHT aufbereitet werden (kein Filtern, kein Entkeimen) — es muss von Natur aus rein sein. Deutschland hat über **500 amtlich anerkannte Mineralwasserquellen** — mehr als jedes andere Land der Welt. Jede Quelle hat ein einzigartiges Mineralprofil, geprägt durch die Gesteinsschichten, durch die das Wasser über Jahrzehnte bis Jahrhunderte gesickert ist.\n\n**Abgrenzung**: **Quellwasser** stammt auch aus unterirdischen Quellen, unterliegt aber weniger strengen Anforderungen. **Tafelwasser** kann aus verschiedenen Wasserarten gemischt und aufbereitet werden — es ist ein industrielles Produkt (z.B. Bonaqua). **Heilwasser** muss wissenschaftlich nachgewiesene heilende Wirkung haben und wird vom Bundesinstitut für Arzneimittel zugelassen.\n\n**Die Reise des Wassers**: Regenwasser versickert im Boden, durchdringt verschiedene Gesteinsschichten (Sand, Kies, Kalkstein, Basalt, Granit) und nimmt dabei Mineralien auf. Je länger der Weg, desto stärker mineralisiert. Gerolsteiner durchquert vulkanisches Gestein der Eifel — daher besonders reich an Calcium und Magnesium. Volvic kommt aus vulkanischem Basalt in der Auvergne — natürlich weich und mineralarm.", quiz: [{ question: "Was unterscheidet natürliches Mineralwasser von Tafelwasser?", options: ["Nur der Preis", "Mineralwasser muss aus einer amtlich anerkannten Quelle stammen und darf nicht aufbereitet werden", "Tafelwasser hat mehr Mineralien", "Es gibt keinen Unterschied"], correct: 1, explanation: "Natürliches Mineralwasser muss aus einer geschützten Quelle stammen, direkt abgefüllt werden und darf nicht aufbereitet werden. Tafelwasser ist ein industriell hergestelltes Produkt." }, { question: "Warum hat Deutschland so viele Mineralwasserquellen (über 500)?", options: ["Wegen des vielen Regens", "Wegen der vielfältigen Geologie mit unterschiedlichen Gesteinsschichten", "Wegen staatlicher Subventionen", "Weil mehr gesucht wurde als in anderen Ländern"], correct: 1, explanation: "Deutschlands vielfältige Geologie — von vulkanischem Gestein der Eifel über Kalkstein der Schwäbischen Alb bis zum Granit des Schwarzwalds — sorgt für eine einzigartige Vielfalt an Mineralwässern." }] },
      { title: "Mineralstoffe lesen und verstehen", content: "Jede Mineralwasser-Flasche trägt eine **Analyse** mit der exakten Zusammensetzung. Die wichtigsten Werte:\n\n**Calcium (Ca²⁺)**: Ab 150mg/l = 'calciumreich'. Wichtig für Knochen und Zähne. **Gerolsteiner**: 348mg/l — eines der calciumreichsten Wässer. **Empfehlung**: 1.000mg/Tag (Erwachsene). 2 Liter Gerolsteiner decken 70%!\n\n**Magnesium (Mg²⁺)**: Ab 50mg/l = 'magnesiumreich'. Wichtig für Muskeln, Nerven, Enzyme. Mangel zeigt sich durch Muskelkrämpfe. **Gerolsteiner**: 108mg/l. **Empfehlung**: 300–400mg/Tag.\n\n**Natrium (Na⁺)**: Unter 20mg/l = 'natriumarm' (geeignet für natriumarme Ernährung). Wichtig bei Bluthochdruck — dann natriumarme Wässer bevorzugen. **Volvic**: 12mg/l (natriumarm). Für Sportler eher natriumreichere Wässer.\n\n**Hydrogencarbonat (HCO₃⁻)**: Puffert Säure im Magen. Werte über 600mg/l sind 'hydrogencarbonatreich'. Hilft bei Sodbrennen und säurebedingten Magenbeschwerden. **Gerolsteiner**: 1.816mg/l — extrem hoch.\n\n**Sulfat (SO₄²⁻)**: Ab 200mg/l = 'sulfatreich'. Fördert die Verdauung. **Achtung**: Sulfatreiche Wässer sind für Babys NICHT geeignet (Durchfall).\n\n**Fluorid (F⁻)**: Ab 1mg/l = 'fluoridhaltig'. Schützt den Zahnschmelz. Aber: Nicht überdosieren.\n\n**Gesamtmineralisierung**: Unter 500mg/l = mineralarm (leicht, neutral). 500–1500mg/l = mittel (ausgewogen). Über 1500mg/l = mineralreich (geschmacksintensiv, medizinisch wertvoll).\n\n**Praktischer Tipp**: Für den Alltag ein ausgewogenes Wasser. Beim Sport ein natriumreicheres. Bei Sodbrennen eines mit viel Hydrogencarbonat. Für Babys: Natriumarm (<20mg/l), sulfatarm (<240mg/l), nitratarm (<10mg/l), keimfrei.", quiz: [{ question: "Ab welchem Wert gilt ein Mineralwasser als 'calciumreich'?", options: ["Ab 50mg/l", "Ab 100mg/l", "Ab 150mg/l", "Ab 300mg/l"], correct: 2, explanation: "Gemäß Mineral- und Tafelwasserverordnung darf sich ein Wasser ab 150mg/l Calcium 'calciumreich' nennen." }, { question: "Warum ist Gerolsteiner besonders mineralreich?", options: ["Weil Mineralien zugesetzt werden", "Weil es durch vulkanisches Gestein der Eifel fließt", "Weil es aus dem Meer stammt", "Weil es besonders lange gelagert wird"], correct: 1, explanation: "Gerolsteiner kommt aus dem vulkanischen Gestein der Eifel, das besonders reich an Calcium, Magnesium und Hydrogencarbonat ist." }] },
      { title: "Kohlensäure — Wissenschaft und Geschmack", content: "**Was ist Kohlensäure?** CO₂ (Kohlendioxid) löst sich in Wasser und bildet Kohlensäure (H₂CO₃). Diese zerfällt beim Öffnen wieder in CO₂ + H₂O — das Sprudeln. **Natürliche Kohlensäure** stammt aus vulkanischer Aktivität im Untergrund (z.B. Gerolsteiner, Apollinaris). **Zugesetzte Kohlensäure** wird industriell hergestellt und dem Wasser beigefügt.\n\n**Die drei Kohlensäure-Stufen**: **Classic/Sprudel** (>4,5g CO₂/l): Stark prickelnd, erfrischend. **Medium** (1,5–4,5g CO₂/l): Sanft, vielseitig. **Still/Naturell** (<1,5g CO₂/l): Kaum oder kein Prickeln.\n\n**Wirkung auf den Körper**: Kohlensäure regt die Speichelproduktion an (gut für Verdauung). Sie aktiviert Kälterezeptoren auf der Zunge — daher wirkt Sprudelwasser erfrischender als stilles. Bei empfindlichem Magen kann starke Kohlensäure Blähungen verursachen. **Mythos**: 'Kohlensäure macht die Knochen weich' — FALSCH. Keine wissenschaftliche Grundlage.\n\n**Kohlensäure und Wein**: Zum Verkosten von Wein eignet sich stilles Wasser am besten — Kohlensäure reinigt zwar den Gaumen, kann aber die Wahrnehmung von Weinaromen verändern. Zu Sekt/Champagner: Stilles Wasser, damit die Perlage des Weins wirken kann.\n\n**Kohlensäure und Bier**: Bier hat natürlicherweise Kohlensäure aus der Gärung (4–7g CO₂/l, je nach Stil). Mehr als die meisten Mineralwässer!", quiz: [{ question: "Warum wirkt Sprudelwasser erfrischender als stilles Wasser?", options: ["Weil es kälter ist", "Weil CO₂ Kälterezeptoren auf der Zunge aktiviert", "Weil es mehr Mineralien hat", "Weil es schneller den Durst löscht"], correct: 1, explanation: "Gelöstes CO₂ stimuliert Kälte- und Schmerzrezeptoren (TRPA1) auf der Zunge — das erzeugt das erfrischende, leicht pikante Gefühl." }] },
    ],
    finalExam: [
      { question: "Was darf mit natürlichem Mineralwasser NICHT gemacht werden?", options: ["Kohlensäure zusetzen", "Aufbereiten, filtern oder entkeimen", "In Glasflaschen abfüllen", "Exportieren"], correct: 1, explanation: "Natürliches Mineralwasser darf nicht aufbereitet werden — es muss von Natur aus rein sein. Kohlensäure zusetzen oder entfernen ist aber erlaubt." },
      { question: "Welchen Mineralstoff sollte Babywasser NICHT in großen Mengen enthalten?", options: ["Calcium", "Magnesium", "Sulfat (max. 240mg/l)", "Hydrogencarbonat"], correct: 2, explanation: "Zu viel Sulfat kann bei Babys Durchfall verursachen. Babywasser sollte max. 240mg/l Sulfat, max. 20mg/l Natrium und max. 10mg/l Nitrat enthalten." },
    ],
  },

  {
    slug: "saft",
    title: "Saft, Nektar & Schorle",
    icon: "🧃",
    description: "Direktsaft vs. Konzentrat, Qualitätsmerkmale, gesundheitliche Aspekte und die perfekte Schorle.",
    color: "from-orange-500 to-orange-700",
    difficulty: "Einsteiger",
    duration: "ca. 20 Min.",
    lessons: [
      { title: "Saft, Nektar, Fruchtsaftgetränk — die rechtlichen Unterschiede", content: "Die **Fruchtsaftverordnung** definiert exakt, was sich wie nennen darf:\n\n**Fruchtsaft (100%)**: Muss 100% Frucht enthalten. Zwei Varianten: **Direktsaft** wird direkt nach der Ernte gepresst und abgefüllt (oder schonend pasteurisiert). Höchste Qualität, bester Geschmack. **Saft aus Konzentrat** wird nach der Ernte zu Konzentrat eingedickt (Wasser entzogen für billigeren Transport), am Abfüllort wird Wasser wieder zugesetzt. Die entzogende Menge Wasser muss exakt wieder zugeführt werden. Zuckerzusatz ist bei Fruchtsaft seit 2012 EU-weit verboten — der Zucker im Saft ist ausschließlich Fruchtzucker.\n\n**Fruchtnektar (25–50% Frucht)**: Für Früchte die als 100% Saft zu sauer oder zu dickflüssig wären: Banane, Mango, Sauerkirsche, Johannisbeere, Maracuja. Wasser und Zucker (max. 20%) werden zugesetzt. **Merke**: Auf dem Etikett steht immer der Mindestfruchtgehalt.\n\n**Fruchtsaftgetränk (6–30% Frucht)**: Im Grunde aromatisiertes Zuckerwasser. Oft bei Billigprodukten. **Beispiel**: 'Orangenfruchtsaftgetränk' hat nur 6% Orangensaft. **Tipp**: Immer das Etikett lesen — der Name kann täuschen.\n\n**Fruchtschorle**: Muss mindestens 50% Fruchtsaft enthalten (meist Apfelsaft + Mineralwasser). Alles unter 50% ist ein 'Fruchtsaftgetränk mit Kohlensäure'.", quiz: [{ question: "Was ist der Mindestfruchtgehalt eines 'Fruchtsaftgetränks'?", options: ["50%", "100%", "6–30%", "0% — es ist synthetisch"], correct: 2, explanation: "Fruchtsaftgetränke müssen nur 6–30% Fruchtgehalt haben — der Rest ist Wasser, Zucker und Aromen. Deutlich weniger als Saft (100%) oder Nektar (25–50%)." }, { question: "Darf Fruchtsaft Zucker zugesetzt werden?", options: ["Ja, bis zu 10%", "Ja, unbegrenzt", "Nein, seit 2012 EU-weit verboten", "Nur bei Bio-Säften"], correct: 2, explanation: "Seit 2012 ist die Zugabe von Zucker zu Fruchtsaft in der EU verboten. Der enthaltene Zucker ist ausschließlich natürlicher Fruchtzucker." }] },
      { title: "Die beliebtesten Säfte und ihre Besonderheiten", content: "**Orangensaft** — Nr. 1 in Deutschland (7,5 Liter pro Kopf/Jahr). Reich an Vitamin C (ein Glas deckt den Tagesbedarf). **Direktsaft vs. Konzentrat**: Geschmacklich spürbar — Direktsaft ist fruchtiger, frischer, teurer. **Fun Fact**: Für 1 Liter Orangensaft braucht man ca. 2,5 kg Orangen (12–15 Stück).\n\n**Apfelsaft** — Nr. 2, der deutsche Klassiker. **Klar** (filtriert): Hell, milder, länger haltbar. **Naturtrüb** (unfiltriert): Enthält mehr Polyphenole (Antioxidantien), Pektin und Vitamine — gesünder! Der trübe Bodensatz ist kein Zeichen schlechter Qualität, sondern von mehr Inhaltsstoffen. Beste Qualität: Streuobstwiesen-Apfelsaft von regionalen Keltereien.\n\n**Tomatensaft** — Besonderheit: Schmeckt in der Luft besser als am Boden! Bei niedrigem Luftdruck (Flugzeug) werden süße und salzige Geschmäcker gedämpft, Umami (in Tomaten) wird verstärkt. Daher der Klassiker auf Flugreisen. Kalorienarm (17 kcal/100ml), reich an Lycopin (Antioxidans).\n\n**Cranberrysaft** — Fast immer als Nektar erhältlich (pur zu sauer/bitter). Reich an Proanthocyanidinen — Studien zeigen Wirksamkeit bei Harnwegsinfekten. Wichtig für Cocktails: Cosmopolitan, Cape Codder.\n\n**Multivitaminsaft** — Mischung verschiedener Früchte, oft mit zugesetzten Vitaminen. Qualität variiert stark. Etikett prüfen: 100% Saft oder Nektar? Welcher Fruchtgehalt?", quiz: [{ question: "Warum schmeckt Tomatensaft im Flugzeug besser als am Boden?", options: ["Weil die Luft trockener ist", "Weil bei niedrigem Luftdruck Umami verstärkt und Süße/Salz gedämpft wird", "Weil er im Flugzeug frischer ist", "Weil die Kabine kälter ist"], correct: 1, explanation: "Bei niedrigem Kabinendruck werden süße und salzige Geschmäcker um 30% gedämpft, während Umami (stark in Tomaten) intensiver wahrgenommen wird." }] },
    ],
    finalExam: [
      { question: "Was ist gesünder — klarer oder naturtrüber Apfelsaft?", options: ["Klarer — er ist reiner", "Naturtrüber — er enthält mehr Polyphenole und Pektin", "Kein Unterschied", "Klarer — weniger Zucker"], correct: 1, explanation: "Naturtrüber Apfelsaft enthält mehr Polyphenole (Antioxidantien), Pektin und sekundäre Pflanzenstoffe als die filtrierte, klare Variante." },
    ],
  },

  {
    ...
    icon: "🥂",
    description: "Herstellungsmethoden, Qualitätsstufen, Dosage, Jahrgang und die Kunst des Degorgierens.",
    color: "from-pink-500 to-pink-700",
    difficulty: "Fortgeschritten",
    duration: "ca. 30 Min.",
    lessons: [
      { title: "Die Herstellungsmethoden — was kostet warum was", content: "**Méthode Traditionnelle / Flaschengärung** (Champagner, Crémant, Cava, dt. Winzersekt): Die aufwändigste und teuerste Methode. Ein fertiger Stillwein (Grundwein) wird in Flaschen gefüllt, mit Hefe und Zucker ('Liqueur de Tirage') versetzt. Die **zweite Gärung findet IN DER FLASCHE** statt — daher entsteht die feinste, anhaltendste Perlage. Nach der Gärung lagert der Wein **auf der Hefe** ('sur lie'): Non-Vintage Champagner mind. 15 Monate, Vintage mind. 36 Monate. Die Hefeautolyse (Hefezellen sterben ab und setzen Aminosäuren frei) gibt: Brioche, Toast, Nuss, cremige Textur. Dann: **Rütteln** (Remuage) — über Wochen wird die Flasche gedreht bis die Hefe im Flaschenhals sitzt. **Degorgieren** (Dégorgement): Flaschenhals wird eingefroren, Hefe-Pfropf schießt beim Öffnen heraus. Dann: **Dosage** (Versanddosage) — Zucker-Wein-Gemisch bestimmt die Süßestufe.\n\n**Méthode Charmat / Tankgärung** (Prosecco, Lambrusco, dt. Sekt): Zweite Gärung im großen Drucktank statt in Flaschen. Schneller, günstiger, größere Mengen. Perlage ist gröber und weniger persistent. Kaum Hefeautolyse → fruchtigere, einfachere Aromen. Perfekt für Weine die frisch und fruchtig bleiben sollen (Prosecco = Glera-Traube, die ihre Frucht verlieren würde bei langer Hefelagerung).\n\n**Méthode Ancestrale** (Pétillant Naturel/Pet Nat): Die älteste Methode — die ERSTE Gärung wird in der Flasche beendet (kein Zucker/Hefe zugesetzt). Unkontrollierter, 'wilder', oft trüb, oft mit weniger Druck. Trend in der Naturwein-Szene.\n\n**Kohlensäure-Imprägnierung**: CO₂ wird einfach in Wein gepumpt. Billigste Methode. Grobe Blasen, schnell verfliegend. Typisch für einfache 'Perlweine' und Frizzante.", quiz: [{ question: "Was unterscheidet Champagner-Herstellung (Flaschengärung) von Prosecco (Tankgärung) fundamental?", options: ["Nur die Region", "Bei Champagner findet die zweite Gärung in der Flasche statt, bei Prosecco im Tank", "Champagner hat mehr Alkohol", "Prosecco verwendet andere Trauben"], correct: 1, explanation: "Die Flaschengärung (méthode traditionnelle) produziert feinere Perlage und komplexere Aromen durch monatelange Hefelagerung. Tankgärung ist schneller und einfacher." }, { question: "Was bewirkt die Hefeautolyse bei langem Hefelager?", options: ["Mehr Alkohol", "Brioche-, Toast- und Nussaromen + cremige Textur", "Mehr Fruchtigkeit", "Höhere Säure"], correct: 1, explanation: "Beim Hefeabbau (Autolyse) werden Aminosäuren und Mannoproteide freigesetzt, die Brioche/Toast-Aromen und eine cremige Textur erzeugen." }] },
      { title: "Champagner verstehen — Häuser, Stile, Jahrgänge", content: "**Die großen Häuser** (Maisons): **Moët & Chandon** (meistverkaufter Champagner, Flaggschiff: Dom Pérignon). **Veuve Clicquot** (ikonische gelbe Etikette, Madame Clicquot erfand das Rüttelpult). **Krug** (nur Prestige-Champagner, Grande Cuvée ist ein Multi-Vintage-Meisterwerk). **Dom Pérignon** (nur in großen Jahrgängen produziert, mind. 7 Jahre Hefelager). **Bollinger** (James Bonds Champagner, kraftvoll, Pinot-Noir-dominiert). **Ruinart** (ältestes Champagnerhaus, 1729, Blanc de Blancs Spezialist). **Louis Roederer** (Cristal wurde für Zar Alexander II kreiert).\n\n**Winzerchampagner** (Récoltant-Manipulant, 'RM' auf dem Etikett): Kleine Produzenten die eigene Trauben verarbeiten. Oft terroir-getriebener und individueller als Großhäuser. Aktueller Trend: Winzerchampagner bieten oft besseres Preis-Leistungs-Verhältnis.\n\n**Stile**: **Blanc de Blancs** — 100% Chardonnay. Elegant, zitrusbetont, mineralisch. **Blanc de Noirs** — 100% Pinot Noir und/oder Pinot Meunier. Voller, rotwein-fruchtiger. **Rosé** — Durch kurzen Schalenkontakt oder (einzigartig!) Verschnitt von Weiß und Rot. **Non-Vintage (NV)** — Blend verschiedener Jahrgänge → Konsistenz des Hausstils. **Vintage/Millésimé** — Nur in großen Jahren, 100% eines Jahrgangs. **Prestige Cuvée** — Das Beste vom Besten: Dom Pérignon, Cristal, Krug, Comtes de Champagne.\n\n**Dosage-Stufen** (Zuckergehalt, ANDERE Werte als bei Stillwein!): **Brut Nature/Zero Dosage** (0–3g/l): Knochentrocken, ungeschminkt. **Extra Brut** (0–6g/l): Sehr trocken. **Brut** (0–12g/l): Der Standard, 90% aller Champagner. **Extra Dry/Extra Sec** (12–17g/l): ACHTUNG — trotz des Namens leicht süß! **Sec/Trocken** (17–32g/l): Deutlich süß. **Demi-Sec** (32–50g/l): Süß, zu Desserts. **Doux** (>50g/l): Sehr süß, extrem selten.", quiz: [{ question: "Was bedeutet 'RM' auf einem Champagner-Etikett?", options: ["Reservé du Maître — besonders alter Champagner", "Récoltant-Manipulant — ein Winzer der eigene Trauben verarbeitet", "Rosé Millésimé — Rosé mit Jahrgang", "Réserve Magnum — nur in großen Flaschen"], correct: 1, explanation: "RM = Récoltant-Manipulant. Dieser Winzer baut eigene Trauben an und produziert selbst Champagner — im Gegensatz zu NM (Négociant-Manipulant = Große Häuser die Trauben zukaufen)." }] },
    ],
    finalExam: [
      { question: "Warum ist 'Extra Dry' Champagner eigentlich NICHT trocken?", options: ["Marketingtrick", "Historisch war es der trockenste Stil, heute gibt es mit Brut/Zero noch trockenere", "Fehler in der Übersetzung", "Der Name bezieht sich auf die Kohlensäure, nicht den Zucker"], correct: 1, explanation: "Im 19. Jahrhundert war 'Extra Dry' der trockenste verfügbare Stil. Erst später kamen Brut, Extra Brut und Brut Nature dazu — aber der Name blieb." },
      { question: "Was ist ein Pet Nat?", options: ["Ein Haustier-Wein", "Pétillant Naturel — die älteste Methode, erste Gärung wird in der Flasche beendet", "Ein alkoholfreier Sekt", "Ein italienischer Prosecco-Stil"], correct: 1, explanation: "Pet Nat (Pétillant Naturel) ist die älteste Schaumwein-Methode: Der noch gärende Wein wird in Flaschen gefüllt, wo die erste Gärung zu Ende geht." },
    ],
  },

  {
    slug: "likoere",
    title: "Liköre, Spirits & Barwissen",
    icon: "🍸",
    description: "Likörarten, Herstellung, die wichtigsten Bar-Spirituosen, Cocktail-Theorie und Home-Bar aufbauen.",
    color: "from-emerald-600 to-emerald-800",
    difficulty: "Fortgeschritten",
    duration: "ca. 40 Min.",
    lessons: [
      { title: "Was ist ein Likör — und was ist keiner?", content: "**Gesetzliche Definition** (EU Spirituosenverordnung): Ein Likör muss mindestens **100g Zucker pro Liter** und mindestens **15% Vol.** Alkohol enthalten. Die Basis ist eine Spirituose (Neutralalkohol, Rum, Brandy, Whisky) die mit Zucker und Aromen (Früchte, Kräuter, Gewürze, Sahne, etc.) versetzt wird.\n\n**Was KEIN Likör ist** (oft verwechselt): **Gin** — destillierte Spirituose mit Wacholder, kein Zucker (oder minimal). **Vodka** — destillierte Spirituose, neutral. **Vermouth/Wermut** — aromatisierter Wein, kein Likör. **Campari/Aperol** — offiziell 'Bitterliköre' bzw. 'Bitterspiritosen', obwohl Campari nur 25% hat.\n\n**Likör-Kategorien im Detail**:\n\n**Fruchtliköre**: **Cointreau/Grand Marnier/Triple Sec** (Orange — ESSENZIELL für Margarita, Cosmopolitan, Sidecar). **Limoncello** (Zitrone, Süditalien). **Cassis** (schwarze Johannisbeere — für Kir und Kir Royal). **Maraschino** (Maraska-Kirsche — Aviation, Hemingway Daiquiri). **Chambord** (Himbeere).\n\n**Kräuterliköre**: **Jägermeister** (56 Kräuter, Deutschland). **Chartreuse** (130 Kräuter, nur 2 Mönche kennen das Rezept, Grüne = 55% Vol., Gelbe = 40% Vol.). **Bénédictine** (27 Kräuter und Gewürze). **Fernet Branca** (extrem bitter, in Argentinien mit Cola ein Nationalgetränk).\n\n**Cremeliköre**: **Baileys** (Irish Whiskey + Sahne). **Amarula** (Marula-Frucht + Sahne). **Tipp**: Nach dem Öffnen innerhalb von 6 Monaten verbrauchen und kühl lagern.\n\n**Nussliköre**: **Amaretto** (Mandel/Aprikosenkern — Amaretto Sour!). **Frangelico** (Haselnuss). **Nocino** (grüne Walnuss, italienisch).\n\n**Bitterliköre/Amari**: **Campari** (bitter, rot, 25%). **Aperol** (leichter, süßer, orange, 11%). **Averna** (sizilianisch, süß-bitter). **Montenegro** (ausgewogen, komplex). **Cynar** (Artischocke!). Bitters (Angostura, Peychaud's) sind technisch keine Liköre (nicht süß genug), aber unverzichtbar für Cocktails.", quiz: [{ question: "Wie viel Zucker muss ein Likör mindestens enthalten?", options: ["50g pro Liter", "100g pro Liter", "150g pro Liter", "Keinen — Likör ist durch Alkoholgehalt definiert"], correct: 1, explanation: "EU-Verordnung: Mind. 100g Zucker pro Liter UND mind. 15% Vol. Ausnahme: Eierlikör mind. 150g Zucker, Crème de... mind. 250g." }, { question: "Wie viele Kräuter enthält Chartreuse und wer kennt das Rezept?", options: ["56 Kräuter, das ganze Unternehmen", "130 Kräuter, nur 2 Kartäuser-Mönche", "27 Kräuter, ein einzelner Mönch", "200 Kräuter, niemand — es ist ein Computeralgorithmus"], correct: 1, explanation: "Chartreuse enthält 130 Kräuter und Pflanzen. Nur 2 Kartäuser-Mönche im Kloster kennen das vollständige Rezept — und sie dürfen nicht im selben Auto fahren." }] },
      { title: "Die perfekte Home-Bar aufbauen", content: "**Stufe 1 — Die Basics (6 Flaschen, <100€)**:\n1. **Vodka** (z.B. Absolut) — Moscow Mule, Bloody Mary, Screwdriver\n2. **Weißer Rum** (z.B. Havana Club 3) — Mojito, Daiquiri, Cuba Libre\n3. **Gin** (z.B. Tanqueray oder Bombay Sapphire) — Gin Tonic, Negroni\n4. **Bourbon** (z.B. Buffalo Trace oder Jim Beam Black) — Old Fashioned, Whiskey Sour\n5. **Cointreau/Triple Sec** — Margarita, Cosmopolitan, Sidecar\n6. **Campari** — Negroni, Americano, Spritz\n\nDazu: Zitronen, Limetten, Zucker, Angostura Bitters, Tonic Water, Soda, Cola.\n\n**Stufe 2 — Der Aufstieg (+6 Flaschen)**:\n7. **Tequila Blanco** — Margarita, Paloma\n8. **Dunkler Rum** — Dark 'n' Stormy, Mai Tai\n9. **Aperol** — Spritz\n10. **Kahlúa** (Kaffeelikör) — Espresso Martini, White Russian\n11. **Vermouth Rosso** (z.B. Carpano Antica) — Manhattan, Negroni (besserer)\n12. **Vermouth Dry** — Martini\n\n**Stufe 3 — Die Profi-Bar (+8 Flaschen)**:\n13. Mezcal, 14. Rye Whiskey, 15. Scotch (z.B. Monkey Shoulder), 16. Chartreuse Verte, 17. Maraschino (Luxardo), 18. Crème de Cassis, 19. Absinthe, 20. Amaro (z.B. Montenegro)\n\n**Equipment**: Shaker (Boston oder Cobbler), Jigger (Messbecher), Barlöffel, Strainer (Hawthorne), Muddler, Zitruspresse. Gläser: Tumbler/Rocks, Highball/Longdrink, Coupette/Cocktailschale, Weinglas (für Spritze).", quiz: [{ question: "Mit welchen 6 Spirituosen kann man die meisten klassischen Cocktails mixen?", options: ["6 verschiedene Gins", "Vodka, Weißer Rum, Gin, Bourbon, Cointreau, Campari", "Nur Vodka und Rum reichen", "Tequila, Mezcal, Sake, Grappa, Ouzo, Raki"], correct: 1, explanation: "Vodka, Rum, Gin, Bourbon + Cointreau und Campari als Liköre decken: Mojito, Daiquiri, Gin Tonic, Negroni, Old Fashioned, Margarita, Moscow Mule, Cosmopolitan und viele mehr." }] },
    ],
    finalExam: [
      { question: "Welcher Likör ist unverzichtbar für eine Margarita?", options: ["Amaretto", "Campari", "Cointreau/Triple Sec (Orangenlikör)", "Kahlúa"], correct: 2, explanation: "Die klassische Margarita besteht aus Tequila, Limettensaft und Cointreau (Triple Sec). Ohne den Orangenlikör fehlt die Süße und Komplexität." },
      { question: "Warum soll Baileys nach dem Öffnen kühl gelagert und innerhalb von 6 Monaten verbraucht werden?", options: ["Weil der Alkohol verdunstet", "Weil die enthaltene Sahne verderben kann", "Weil sich der Zucker absetzt", "Weil die Flasche oxidiert"], correct: 1, explanation: "Cremeliköre enthalten echte Sahne. Trotz des Alkohols als Konservierungsmittel kann die Sahne nach längerem Öffnen verderben." },
    ],
  },
