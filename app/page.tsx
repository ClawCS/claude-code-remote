      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            { href: "/finder", image: "https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=600&h=400&fit=crop", titleKey: "home.service.finder", descKey: "home.service.finder.desc" },
