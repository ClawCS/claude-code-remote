...
const zertifikatskurse: Kurs[] = [
  // === WEIN ===
  {
    ...
    anbieter: "IHK / Deutsche Wein- und Sommelierschule",
    ...
    url: "https://www.dws-sommelier.de",
    kategorie: "wein",
    highlight: true,
  },
  {
  ...
  // === BIER ===
  {
    ...
    url: "https://www.doemens.org/seminare-kurse/biersommelier/",
    kategorie: "bier",
    highlight: true,
  },
  {
