  ...
  return (
    <>
      <button
        ...
        className="absolute top-2 left-2 z-10 bg-gradient-to-r from-[#DC2626] via-[#EF4444] to-[#F59E0B] text-white text-[11px] font-bold px-2.5 py-1 rounded-full shadow-lg hover:scale-105 transition-transform cursor-pointer"
      >
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#DC2626] via-[#EF4444] to-[#F59E0B] rounded-xl p-4 mb-4 text-white text-center">
        ...
        <div className="space-y-2">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-[#DC2626] via-[#EF4444] to-[#F59E0B] text-white font-bold rounded-xl hover:opacity-90 transition-opacity"
          >
